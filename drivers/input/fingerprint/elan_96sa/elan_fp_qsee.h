...
#define ID_IOCTL_SET_KEYCODE            _IOW(ELAN_IOCTLID, 24, int)
...
#define ID_IOCTL_INPUT_KEYCODE_DOWN     _IOW(ELAN_IOCTLID, 28, int)
#define ID_IOCTL_INPUT_KEYCODE_UP       _IOW(ELAN_IOCTLID, 29, int)
...
#define ID_IOCTL_ENABLE_SPI_CLK         _IOW(ELAN_IOCTLID, 77, int)
#define ID_IOCTL_DISABLE_SPI_CLK        _IOW(ELAN_IOCTLID, 88, int)
#define ID_IOCTL_REQUSEST_IRQ          _IOW(ELAN_IOCTLID, 95, int)
#define ID_IOCTL_POWER_SET             _IOW(ELAN_IOCTLID, 78, int)
// release info.
#define ID_IOCTL_SET_VERSION_0	_IOW(ELAN_IOCTLID, 99, int)
