...
//T MBA add by lijian start for MBA_HDW_FingerPrint_REQC6459
static int tinno_get_FP_is_open(void)
{
    ...
    {
        printk(KERN_INFO "get_goodixfp_3208_is_open not MBA, as default open \n");
        return 1;
    }
    printk(KERN_INFO "get_goodixfp_3208_is_open:sensor_info = %s \n",tinno_sensor_info);
...
#endif
{
	...
	if(!tinno_get_FP_is_open())        //T MBA add by lijian for MBA_HDW_FingerPrint_REQC6459
	    return -1;
